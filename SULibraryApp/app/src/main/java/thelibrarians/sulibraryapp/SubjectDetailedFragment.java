...
public class SubjectDetailedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_research_help, container, false);
        //Referencing the XML that allocates space for each faculty member
        //img = (ImageView) view.findViewById(R.id.computer_top_img);
